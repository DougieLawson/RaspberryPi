...
char updByte [8] = { 0x7E, 0x81, 0xA5, 0x81, 0xA5, 0x99, 0x81, 0x7E};
...
int main (int argc, char **argv) {
    int x, y, z;
//    char *msg[40];
//  char msg[40] = "Merry Xmas & A Happy New Year";
    int c, err = 0;
    int rflag = 0, sflag = 0;
    char *ropt = 0, *sopt = 0;
...
//  msg = sopt;
  ...
  for (;;)
  {
    ...
    {
      y = (unsigned char) sopt[x];
      for (z = 0; z < 8; z++)
      {
       updByte[z] = cp437_font[y][z];
      }
      matrixOn () ;
      delay (100) ;
      matrixOff ();
